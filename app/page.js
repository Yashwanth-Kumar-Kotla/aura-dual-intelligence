...
export default function Home() {
  return (
    <div className="relative overflow-hidden">
      ...
      <section id="how-it-works" className="max-w-6xl mx-auto px-6 py-20 border-t border-gray-200/50 bg-gradient-to-b from-white to-blue-50/20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">You Ask</h3>
              </div>
              <p className="text-gray-600 text-sm mb-4">
                Submit your question to Aura Duo. Your query is sent to both AI models simultaneously for parallel processing.
              </p>
              <div className="bg-blue-50 rounded-xl p-3 text-xs text-gray-700 border border-blue-100">
            ...
            <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="space-y-3">
                <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-100">
                  <p className="text-xs font-semibold text-emerald-700 mb-1">GPT-4o mini</p>
                  <p className="text-xs text-gray-700">Provides a structured first-pass answer with reasoning and assumptions.</p>
                </div>
                <div className="bg-indigo-50 rounded-xl p-3 border border-indigo-100">
                  <p className="text-xs font-semibold text-indigo-700 mb-1">Gemini 1.5 Flash</p>
                  <p className="text-xs text-gray-700">Critiques and reviews, checking for gaps, edge cases, and potential improvements.</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                  3
                </div>
                <h3 className="text-lg font-semibold text-gray-900">Synthesis</h3>
              </div>
              <p className="text-gray-600 text-sm mb-4">
                GPT synthesizes both responses into one polished answer, combining their strengths and resolving any disagreements.
              </p>
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-3 text-xs text-gray-700 border border-blue-100">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 p-5 shadow-sm">
            ...
            <p className="text-xs text-gray-600">Both AIs work simultaneously, saving time and providing diverse perspectives instantly.</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 p-5 shadow-sm">
            ...
            <p className="text-xs text-gray-600">Gemini acts as a quality reviewer, catching errors, gaps, and suggesting improvements.</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 p-5 shadow-sm">
            ...
            <p className="text-xs text-gray-600">See both individual responses and the final synthesized answer for complete transparency.</p>
          </div>
        </div>
      </section>
    </div>
